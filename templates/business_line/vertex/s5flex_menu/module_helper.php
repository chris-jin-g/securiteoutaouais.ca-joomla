 ...
 * @since		1.5
 */
abstract class S5JModuleHelper
{
	/**
	...
	public static function &getModule($name, $title = null)
	{
		...
		if (is_null($result) && substr($name, 0, 8) == 'mod_')
		{
			$result				= new stdClass;
			$result->id			= 0;
			$result->title		= '';
	...
	public static function &getModules($position)
	{
		...
		if (count($result) == 0)
		{
			...
			{
				$result[0] = S5JModuleHelper::getModule('mod_'.$position);
