...
function s5_responsive_mobile_body_classes() {
	if (document.body.offsetWidth <= s5_responsive_mobile_trigger_width) {
		if (s5_responsive_mobile_original_body_class != "") {
			document.body.className = "s5_responsive_mobile_present";
		} else {
			document.body.className = "s5_responsive_mobile_present " + s5_responsive_mobile_original_body_class;
		}
	} else {
		document.body.className = s5_responsive_mobile_original_body_class;
	}
}
