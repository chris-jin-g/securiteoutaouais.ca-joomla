...
class TimeWorkedViewClients extends JViewLegacy
{
	/**
	 * {@inheritdoc}
	 */
	...
	protected function _setToolBar()
	{
		...
		$canDo = TimeWorkedHelper::getActions('client');
		...
		if ($canDo->get('core.delete'))
		{
			...
			if ($canDo->get('core.delete'))
			{
				JToolBarHelper::deleteList('COM_TIMEWORKED_DELETE_QUERY_STRING', 'clients.delete', 'JTOOLBAR_DELETE');
				JToolBarHelper::divider();
			}

			if ($canDo->get('core.admin'))
			{
                JToolBarHelper::publishList('clients.publish', 'JTOOLBAR_PUBLISH', true);
                JToolBarHelper::divider();
                JToolbarHelper::unpublishList('clients.unpublish', 'JTOOLBAR_UNPUBLISH', true);
                JToolBarHelper::divider();
